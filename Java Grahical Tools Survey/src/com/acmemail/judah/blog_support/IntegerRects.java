...
public class IntegerRects extends JPanel
{
    ...
    public IntegerRects( int width, int height )
    {
    ...
    private void drawRect( int xco, int yco, int width, int height )
    {
