...
public class Ball
{
    ...
    /** 
     * Returns the magnitude of the speed of the ball.
     * This is defined as the magnitude of the vector
     * connecting two points separated by one time-step
     * (the length of the hypotenuse
     * of the right triangle formed by using 
     * delta-x and delta-y as the legs).
     * 
     * @return the magnitude of speed.
     */
    public double getSpeed() 
    {
        double  deltaXSquared   = ballXDelta * ballXDelta;
        double  deltaYSquared   = ballYDelta * ballYDelta;
        double  speed           = Math.sqrt(deltaXSquared + deltaYSquared);
        return speed;
    }
    
    /**
     * Sets the speed of the ball.
     * Speed is defined as the magnitude of the vector
     * connecting two points separated by one time-step.
     * The new delta-x and delta-y are determined
     * by multiplying the current delta-x and delta-y
     * by the proportion of the new speed to the old speed.
     * 
    ...
    public void setSpeed( double newSpeed )
    {
        ...
        double  ratio       = newSpeed / currSpeed;
        ballXDelta *= ratio;
        ballYDelta *= ratio;
    }
}
