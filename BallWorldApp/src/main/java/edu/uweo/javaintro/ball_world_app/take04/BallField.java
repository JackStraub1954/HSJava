...
//               repaint();
    ...
    /**
     * Pause/resume the bouncing ball animation. 
     * True to pause, false to resume.
     * State is not checked;
     * pausing a paused animation,
     * or resuming a running animation
     * has no effect.
     * 
     * @param paused    <em>true</em> to pause the animation,
     *                  <em>false</em> to resume
     */
    ...
    /**
     * Returns the single ball in the animation
     * at this stage of the tutorial.
     * 
     * @return
     */
    public Ball getBall()
