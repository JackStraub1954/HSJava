...
public class FrameTimer implements Runnable
{
     ...
     * 
     * @return true if this timer is paused, false otherwise
     */
    ...
    /**
     * Pause/resume this timer. 
     * True to pause, false to resume.
     * State is not checked;
     * pausing a paused timer,
     * or resuming a running timer
     * has no effect.
     * 
     * @param paused    <em>true</em> to pause this timer,
