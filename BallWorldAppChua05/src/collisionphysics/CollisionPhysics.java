...
public class CollisionPhysics {
    ...
    public static void pointIntersectsMovingPoint(
        float pointX1, float pointY1, float speedX1, float speedY1, float radius1,
        float pointX2, float pointY2, float speedX2, float speedY2, float radius2,
        float timeLimit, CollisionResponse response1, CollisionResponse response2)
    {
